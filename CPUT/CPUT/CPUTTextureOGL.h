...
public:
    ...
    static CPUTTexture *CreateTexture(const cString &name, GLenum internalFormat, int width, int height, 
                   GLenum format, GLenum type, void* pData, bool bIsImmutableStorage = false);
    ...
    void InitGLTexture(GLenum internalFormat, int width, int height, GLenum format, GLenum type, void* pData, bool bIsImmutableStorage = false);
    ...
    void UpdateData(void *pData, GLenum Format, GLenum Type);
};
