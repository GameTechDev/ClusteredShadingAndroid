...
public:
    ...
    static CPUTFont *LoadBMFont(const cString& pPath, const cString& pFileName);

    void LayoutText(CPUTGUIVertex *pVtxBuffer, int *pWidth, int *pHeight, const cString& text, int tlx, int tly);
